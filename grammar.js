...
module.exports = grammar({
  ...
  rules: {
    ...
    update_expression: $ => {
      ...
      const operator = field('operator', $.update_operator);
    ...
    structure_datatype: _ => caseInsensitive('structure'),
    ...
    autoinstantiate_keyword: _ => token(prec(PREC.KEYWORD, caseInsensitive('autoinstantiate'))),
    ...
    readonly_keyword: _ => token(prec(PREC.KEYWORD, caseInsensitive('readonly'))),
    ref_keyword: _ => token(prec(PREC.KEYWORD, caseInsensitive('ref'))),
